 ...
 */
@Api(name = "messageEndpoint", namespace = @ApiNamespace(ownerDomain = "enpoints.com", ownerName = "enpoints.com", packagePath=""))
...
public class MessageEndpoint {
   ...
   */
  private static final String API_KEY = "AIzaSyCmIVrCnW7w0Xp-o1k-2MYqEMqJGcAxgBM";
